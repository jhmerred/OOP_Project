...
public final class FragmentAddBinding implements ViewBinding {
  ...
  private FragmentAddBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSubmit,
      @NonNull EditText etImageUrl, @NonNull EditText etName) {
  ...
  public static FragmentAddBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAddBinding((ConstraintLayout) rootView, btnSubmit, etImageUrl, etName);
    }
